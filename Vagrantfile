...
# This vagrant environment provides a clean slate to develop or test the splunk
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder ".", "/etc/puppetlabs/code/environments/production/splunk"
